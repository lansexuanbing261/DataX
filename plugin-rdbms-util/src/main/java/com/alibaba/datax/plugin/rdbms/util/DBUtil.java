...
//                    throw new Exception(DBUtilErrorCode.JDBC_NULL.toString());
    ...
    public static Connection getConnection(final DataBaseType dataBaseType,
        ...
        System.out.println("before_retry_socketTimeOut: " + socketTimeout);
        try {
    ...
    private static synchronized Connection connect(DataBaseType dataBaseType,
        ...
        try {
            System.out.println("classDriver: " + dataBaseType.getDriverClassName());
            String driver = "com.cloudera.impala.jdbc41.Driver";
            Class.forName(driver);
            //Class.forName(dataBaseType.getDriverClassName());
            System.out.println("load driver finished ");
            DriverManager.setLoginTimeout(Constant.TIMEOUT_SECONDS);
            System.out.println("time_seconds: " + Constant.TIMEOUT_SECONDS);
            System.out.println("url: " + url);
