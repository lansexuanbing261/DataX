...
public enum DBUtilErrorCode implements ErrorCode {
    ...
    IMPALA_CONN_USERPWD_ERROR("IMPALAErrCode-01","数据库用户名或者密码错误，请检查填写的账号密码或者联系DBA确认账号和密码是否正确"),
    IMPALA_CONN_IPPORT_ERROR("IMPALAErrCode-02","数据库服务的IP地址或者Port错误，请检查填写的IP地址和Port或者联系DBA确认IP地址和Port是否正确。如果是同步中心用户请联系DBA确认idb上录入的IP和PORT信息和数据库的当前实际信息是一致的"),
    IMPALA_CONN_DB_ERROR("IMPALAErrCode-03","数据库名称错误，请检查数据库实例名称或者联系DBA确认该实例是否存在并且在正常服务"),
    ...
    IMPALA_QUERY_TABLE_NAME_ERROR("IMPALAErrCode-04","表不存在，请检查表名或者联系DBA确认该表是否存在"),
    IMPALA_QUERY_SQL_ERROR("IMPALAErrCode-05","SQL语句执行出错，原因可能是你填写的列不存在或者where条件不符合要求，1，请检查该列是否存在，如果是常量或者变量，请使用英文单引号’包起来;  2，请检查Where条件是否存在拼写或语法错误"),
    IMPALA_QUERY_SELECT_PRI_ERROR("IMPALAErrCode-06","读表数据出错，因为账号没有读表的权限，请联系DBA确认该账号的权限并授权"),
    IMPALA_QUERY_SQL_PARSER_ERROR("IMPALAErrCode-07","SQL语法出错，请检查Where条件是否存在拼写或语法错误"),
    ...
    IMPALA_PRE_SQL_ERROR("IMPALAErrCode-08", "PreSQL语法错误，请检查"),
    IMPALA_POST_SQL_ERROR("IMPALAErrCode-09", "PostSql语法错误，请检查"),

    //SplitPK 错误
    MYSQL_SPLIT_PK_ERROR("MYSQLErrCode-11","SplitPK错误，请检查"),
    ORACLE_SPLIT_PK_ERROR("ORACLEErrCode-10","SplitPK错误，请检查"),
    IMPALA_SPLIT_PK_ERROR("IMPALAErrCode-10","SplitPK错误，请检查"),
    ...
    IMPALA_INSERT_ERROR("IMPALAErrCode-11","数据库没有写权限，请联系DBA"),
    IMPALA_DELETE_ERROR("IMPALAErrCode-12","数据库没有Delete权限，请联系DBA"),
