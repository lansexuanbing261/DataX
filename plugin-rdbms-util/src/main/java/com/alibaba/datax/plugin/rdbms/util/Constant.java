...
public final class Constant {
    ...
    public static final String IMPALA_DATABASE = "Unknown database";
    public static final String IMPALA_CONNEXP = "The Network Adapter could not establish the connection";
    public static final String IMPALA_ACCDENIED = "Access denied";
    public static final String IMPALA_TABLE_NAME = "table or view does not exist";
    public static final String IMPALA_SELECT_PRI = "insufficient privileges";
    public static final String IMPALA_SQL = "invalid identifier";
