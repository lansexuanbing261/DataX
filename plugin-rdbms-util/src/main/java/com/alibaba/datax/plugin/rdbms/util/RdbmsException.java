...
public class RdbmsException extends DataXException{
    ...
    public static DataXException asConnException(DataBaseType dataBaseType,Exception e,String userName,String dbName){
        ...
        if (dataBaseType.equals(DataBaseType.Impala)){
            DBUtilErrorCode dbUtilErrorCode = impalaConnectionErrorAna(e.getMessage());
            if (dbUtilErrorCode == DBUtilErrorCode.IMPALA_CONN_DB_ERROR && dbName != null){
                return DataXException.asDataXException(dbUtilErrorCode,"该数据库名称为："+dbName+" 具体错误信息为："+e);
            }
            if (dbUtilErrorCode == DBUtilErrorCode.IMPALA_CONN_USERPWD_ERROR ){
                return DataXException.asDataXException(dbUtilErrorCode,"该数据库用户名为："+userName+" 具体错误信息为："+e);
            }
            return DataXException.asDataXException(dbUtilErrorCode," 具体错误信息为："+e);
        }
    ...
    public static DBUtilErrorCode impalaConnectionErrorAna(String e){
        if (e.contains(Constant.IMPALA_DATABASE)){
            return DBUtilErrorCode.IMPALA_CONN_DB_ERROR;
        }

        if (e.contains(Constant.IMPALA_CONNEXP)){
            return DBUtilErrorCode.IMPALA_CONN_IPPORT_ERROR;
        }

        if (e.contains(Constant.IMPALA_ACCDENIED)){
            return DBUtilErrorCode.IMPALA_CONN_USERPWD_ERROR;
        }
    ...
    public static DataXException asQueryException(DataBaseType dataBaseType, Exception e,String querySql,String table,String userName){
        ...
        if (dataBaseType.equals(DataBaseType.Impala)){
            DBUtilErrorCode dbUtilErrorCode = impalaQueryErrorAna(e.getMessage());
            if (dbUtilErrorCode == DBUtilErrorCode.IMPALA_QUERY_TABLE_NAME_ERROR && table != null){
                return DataXException.asDataXException(dbUtilErrorCode,"表名为："+table+" 执行的SQL为:"+querySql+" 具体错误信息为："+e);
            }
            if (dbUtilErrorCode == DBUtilErrorCode.IMPALA_QUERY_SELECT_PRI_ERROR){
                return DataXException.asDataXException(dbUtilErrorCode,"用户名为："+userName+" 具体错误信息为："+e);
            }
    ...
    public static DBUtilErrorCode impalaQueryErrorAna(String e){
        if (e.contains(Constant.IMPALA_TABLE_NAME)){
            return DBUtilErrorCode.IMPALA_QUERY_TABLE_NAME_ERROR;
        }else if (e.contains(Constant.IMPALA_SQL)){
            return DBUtilErrorCode.IMPALA_QUERY_SQL_ERROR;
        }else if (e.contains(Constant.IMPALA_SELECT_PRI)){
            return DBUtilErrorCode.IMPALA_QUERY_SELECT_PRI_ERROR;
        }
        return DBUtilErrorCode.READ_RECORD_FAIL;
    }
    ...
    public static DataXException asSqlParserException(DataBaseType dataBaseType, Exception e,String querySql){
        ...
        if (dataBaseType.equals(DataBaseType.Impala)){
            throw DataXException.asDataXException(DBUtilErrorCode.IMPALA_QUERY_SQL_PARSER_ERROR,"执行的SQL为:"+querySql+" 具体错误信息为：" +e);
        }
    ...
    public static DataXException asPreSQLParserException(DataBaseType dataBaseType, Exception e,String querySql){
        ...
        if (dataBaseType.equals(DataBaseType.Impala)){
            throw DataXException.asDataXException(DBUtilErrorCode.IMPALA_PRE_SQL_ERROR,"执行的SQL为:"+querySql+" 具体错误信息为：" +e);
        }
        throw DataXException.asDataXException(DBUtilErrorCode.READ_RECORD_FAIL,"执行的SQL为:"+querySql+" 具体错误信息为："+e);
    }
    ...
    public static DataXException asPostSQLParserException(DataBaseType dataBaseType, Exception e,String querySql){
        ...
        if (dataBaseType.equals(DataBaseType.Impala)){
            throw DataXException.asDataXException(DBUtilErrorCode.IMPALA_POST_SQL_ERROR,"执行的SQL为:"+querySql+" 具体错误信息为：" +e);
        }
        throw DataXException.asDataXException(DBUtilErrorCode.READ_RECORD_FAIL,"执行的SQL为:"+querySql+" 具体错误信息为："+e);
    }
    ...
    public static DataXException asInsertPriException(DataBaseType dataBaseType, String userName,String jdbcUrl){
        ...
        if (dataBaseType.equals(DataBaseType.Impala)){
            throw DataXException.asDataXException(DBUtilErrorCode.IMPALA_INSERT_ERROR,"用户名为:"+userName+" jdbcURL为："+jdbcUrl);
        }
    ...
    public static DataXException asDeletePriException(DataBaseType dataBaseType, String userName,String jdbcUrl){
        ...
        if (dataBaseType.equals(DataBaseType.Impala)){
            throw DataXException.asDataXException(DBUtilErrorCode.IMPALA_DELETE_ERROR,"用户名为:"+userName+" jdbcURL为："+jdbcUrl);
        }
    ...
    public static DataXException asSplitPKException(DataBaseType dataBaseType, Exception e,String splitSql,String splitPkID){
        ...
        if (dataBaseType.equals(DataBaseType.Impala)){
            return DataXException.asDataXException(DBUtilErrorCode.IMPALA_SPLIT_PK_ERROR,"配置的SplitPK为: "+splitPkID+", 执行的SQL为: "+splitSql+" 具体错误信息为："+e);
        }
